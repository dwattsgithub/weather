            ...
            .then(function (data) { //data returned from fetch call with geoCordURL
                ...
                fetch(currentWeatherRequestUrl)
                    ...
                    .then(function (data) {
                        ...
                        todayEl.html(''); // Clear the content before displaying new data
                        ...
                        // Create and append elements for displaying current weather
                        var cityLine = $('<p>').text('City: ' + cityName);
                        var dateLine = $('<p>').text('Date: ' + currentDate);
                        var iconElement = $('<img>').attr('src', iconSrc);
                        var temperatureLine = $('<p>').text('Temperature: ' + temperature + '°F');
                        var humidityLine = $('<p>').text('Humidity: ' + humidity + '%');
                        var windLine = $('<p>').text('Wind Speed: ' + windSpeed + ' MPH');

                        todayEl.append(cityLine, dateLine, iconElement, temperatureLine, humidityLine, windLine);
                    })
